    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                ...
                dir = MyApplication.getAppContext().getExternalCacheDir() + File.separator + "log" + File.separator;
            else {
                dir = MyApplication.getAppContext().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
